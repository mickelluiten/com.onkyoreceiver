...
var self, eiscp, send_queue,
    ...
    config = { port: 60128, reconnect: false, reconnect_sleep: 3, modelsets: [], send_delay: 500, verify_commands: false };
...
self.discover = function () {
    ...
    */
	...
	.on('listening', function () {
        ...
        var buffer = eiscp_packet('!pECNQSTN');
